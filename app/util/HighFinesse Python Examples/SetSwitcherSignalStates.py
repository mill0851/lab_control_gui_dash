...
# Set the Use and Show checkboxes for any channel
# Set channel 2 to be used but the pattern will not be displayed. Will be
# updated as soon as a measurement arrives.
dll.SetSwitcherSignalStates(2, 1, 0)
