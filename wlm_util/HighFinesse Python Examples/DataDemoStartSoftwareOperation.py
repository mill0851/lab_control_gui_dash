...
# Start a wavelength meter or laser spectrum analyzer software, the system will
# wait an infinite amount of time to return (-1)
dll.ControlWLMEx(wlmConst.cCtrlWLMShow | wlmConst.cCtrlWLMWait, 0, 0, -1, 0)
# To start the wavelength meter software minimized to the system tray use the
# following command
#dll.ControlWLMEx(wlmConst.cCtrlWLMHide | wlmConst.cCtrlWLMWait, 0, 0, -1, 0)
